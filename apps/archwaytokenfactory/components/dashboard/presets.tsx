export const presets: Preset[] = [
    ...
    "DAO governed by holders"], price: 10, link: "Crowdsource Token.md",
    ...
    "DAO governed by investors"], price: 20, link: "Investment DAO Preset.md",
    ...
    "Team issues further tokens"], price: 25, link: "Early Stage DAO Preset - Documentation.md",
    ...
    "1% allocation to Team"], price: 30, link: "Memecoin Preset.md",
    ...
    "DAO governed by the holders"], price: 34, link: "Common Interest DAO Preset.md",
    ...
    "Team issues further tokens"], price: 40, link: "Protocol DAO.md",
